...
import { ArrowRight, FilePdf, LinkedinLogo } from "phosphor-react";
import { myLifePhotos } from "./content";
import {
      ...
      <MainInofrmationContainer>
        <TextContainer>
          <div className="titleContainer">
            <span className="subtile">Sobre Mim</span>
            <h2 className="secundaryTitle">Conheça minha História</h2>
          </div>
          <div className="descriptionContainer">
            ...
            <button className="learnMoreAboutMe">
              Saiba mais sobre mim <ArrowRight size={20} weight="bold" />
            </button>
          </div>
          <div className="buttonContainer">
            <button className="linkedin">
              <Link
                href="https://www.linkedin.com/in/alexshyjada/"
                legacyBehavior
              >
                <a target="_blank">
                  Linkedin
